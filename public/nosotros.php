...
<div class="video">
  <div class="overlay">
    <div class="contenedor contenido-video">
      <h2>Estancia de Vida Nuestra Señora de Guadalupe</h2>
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit amet dolore harum ea minima debitis corrupti blanditiis placeat! Distinctio perspiciatis necessitatibus eum inventore voluptates pariatur nesciunt fuga eligendi dolore in?</p>
    </div>
  </div>
...
<section class="historia contenedor">
  <div class="historia__imagen">
    <img src="../assets/img/historia.jpg" alt="Imagen de historia" width="100%">
  </div>
